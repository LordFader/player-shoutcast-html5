 ...
 $.fn.airtimeShowSchedule = function(options) {
    ...
    return this.each(function() {
        ...
        function updateWidget(){
            ...
            tableString += "<table width='100%' border='0' cellspacing='4' cellpadding='4' class='widget widget now-playing-list small'>"+
                "<tbody>";
    ...
    $.fn.airtimeLiveTrackInfo = function(options) {
       ...
       return this.each(function() {
           ...
           function updateWidget(){
               ...
               obj.empty();
               obj.append("<span id='status-current-show' style='display:inline-block' class='container-fluid'>"+showStatus+"<br><span id='status-current-show-name'><span class='symbols'>&#9658;&nbsp;</span>"+currentShowName+"<span class='symbols'>&nbsp;&#9668;</span></span></span>" +
